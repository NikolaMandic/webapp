...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5313__auto__,writer__5314__auto__,opt__5315__auto__){return cljs.core._write.call(null,writer__5314__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12308 = 0;while(true){
if((i_12308 < arr.length))
{(arr[i_12308] = null);
{
var G__12309 = (i_12308 + 1);
i_12308 = G__12309;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5313__auto__,writer__5314__auto__,opt__5315__auto__){return cljs.core._write.call(null,writer__5314__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_12315 = (self__.level + 1);while(true){
if((i_12315 <= (new_level + 1)))
{(update[i_12315] = self__.header);
{
var G__12316 = (i_12315 + 1);
i_12315 = G__12316;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12317 = 0;while(true){
if((i_12317 <= self__.level))
{var links_12318 = (update[i_12317]).forward;if(((links_12318[i_12317]) === x__$1))
{(links_12318[i_12317] = (x__$1.forward[i_12317]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__4777__auto__ = (cljs.core.truth_((function (){var and__4768__auto__ = me;if(cljs.core.truth_(and__4768__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4768__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__4777__auto__))
