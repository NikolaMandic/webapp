...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12331 = 0;while(true){
var m_12332 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12332 == null))
{} else
{m_12332.call(null);
if((count_12331 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12333 = (count_12331 + 1);
count_12331 = G__12333;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4768__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4768__auto__)
