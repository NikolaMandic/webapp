...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12337 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12337 = (function (val,box,meta12338){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12337.cljs$lang$type = true;
cljs.core.async.impl.channels.t12337.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12337";
cljs.core.async.impl.channels.t12337.cljs$lang$ctorPrWriter = (function (this__5313__auto__,writer__5314__auto__,opt__5315__auto__){return cljs.core._write.call(null,writer__5314__auto__,"cljs.core.async.impl.channels/t12337");
});
cljs.core.async.impl.channels.t12337.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12337.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12339){var self__ = this;
var _12339__$1 = this;return self__.meta12338;
});
cljs.core.async.impl.channels.t12337.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12339,meta12338__$1){var self__ = this;
var _12339__$1 = this;return (new cljs.core.async.impl.channels.t12337(self__.val,self__.box,meta12338__$1));
});
cljs.core.async.impl.channels.__GT_t12337 = (function __GT_t12337(val__$1,box__$1,meta12338){return (new cljs.core.async.impl.channels.t12337(val__$1,box__$1,meta12338));
});
}
return (new cljs.core.async.impl.channels.t12337(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__5316__auto__,writer__5317__auto__,opts__5318__auto__){return cljs.core._write.call(null,writer__5317__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__5313__auto__,writer__5314__auto__,opt__5315__auto__){return cljs.core._write.call(null,writer__5314__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_12340 = self__.takes.pop();if((taker_12340 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12340))
{var take_cb_12341 = cljs.core.async.impl.protocols.commit.call(null,taker_12340);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12341,taker_12340){
return (function (){return take_cb_12341.call(null,null);
});})(take_cb_12341,taker_12340))
);
} else
{}
{
